 ...
 .image 
   ...
   h2 span.spacer { padding:0 5px; } /* to pad the background color of text to make it look more elegant */
    ...
    <div class="image"> <!-- the image container -->
     ...
     <h2>
     <span>Edward Southerington<span class='spacer'></span><br /><span class='spacer'></span>Economist / Data Analyst</span>       </span>{% include social-media-links.html %}</span> <!-- span tag to beautify it efficiently -->
     </h2> <!-- the text -->
     </div>
